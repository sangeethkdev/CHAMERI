          ...
          >
            ...
            <div className="flex flex-col gap-[10px] lg:contents">
              ...
              <div>
                ...
                />
                <FieldError id="gallery-name-error">{errors.name}</FieldError>
              </div>
              ...
              <div>
                <input
                  ...
                  aria-describedby={errors.email ? 'gallery-email-error' : undefined}
                />
                <FieldError id="gallery-email-error">{errors.email}</FieldError>
              </div>
              ...
              <div>
                ...
                <FieldError id="gallery-phone-error">{errors.phone}</FieldError>
              </div>
              ...
              <div>
                <textarea
                  ...
                  aria-describedby={errors.message ? 'gallery-message-error' : undefined}
                />
                <FieldError id="gallery-message-error">{errors.message}</FieldError>
              </div>
            </div>
