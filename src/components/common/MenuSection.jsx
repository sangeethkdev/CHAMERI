...
const NAV_LINKS = [
  ...
  // { label: 'Kiwano Villa',     href: '/kiwano-villa' },
...
const SOCIALS = [
  ...
  },
  {
    ...
    height: 'clamp(19px, 1.744vw, 22px)',
    svg: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
      ...
      >
        ...
        <div
          style={{
            ...
            background:
              'linear-gradient(110.72deg, rgba(255, 255, 255, 0.22) 1.21%, rgba(196, 196, 196, 0.04) 100%) padding-box, ' +
              'linear-gradient(110.21deg, rgba(255, 255, 255, 0.35) 2.78%, rgba(160, 179, 197, 0.14) 38.77%, rgba(175, 187, 198, 0.15) 66.35%, rgba(255, 255, 255, 0.35) 100%) border-box',
